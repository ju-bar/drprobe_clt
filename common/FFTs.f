...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C   Version 19.11.01, A.Thust * modified by j. Barthel 06.07.07                C
C                                                                              C
...
C SCRODD2048S: Scram./Transp. for FFT named ODDCC8192S, max. dimension 8192 
...
C******************* Initialize Parameters ********************************
      ...
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)' ERROR in the parameter list of ODDCC2048S.'
      STOP
      endif
...
C     array boundaries defined by parameter "ndim".
      ...
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)'   ERROR message from routine ODDCC2048S.'
      write(unit=*,fmt=*)'   Maximum allowed array dimension is 2048.'
      write(unit=*,fmt=*)
      STOP
      endif
...
C******************* Initialize Parameters ********************************
      ...
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)' ERROR in the parameter list of ODDCC8192S.'
      STOP
      endif
...
C     array boundaries defined by parameter "ndim".
      ...
      if(nx .gt. ndim .or. ny .gt. ndim)then
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)'   ERROR message from routine ODDCC8192S.'
      write(unit=*,fmt=*)'   Maximum allowed array dimension is 8192.'
      write(unit=*,fmt=*)
      STOP
      endif
...
C******************* Initialize Parameters ********************************
      ...
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)' ERROR in the parameter list of ODDCC2048.'
      STOP
      endif
...
C     array boundaries defined by parameter "ndim".
      ...
      if(n .gt. ndim)then
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)'   ERROR message from routine ODDCC2048.'
      write(unit=*,fmt=*)'   Maximum allowed array dimension is 2048.'
      write(unit=*,fmt=*)
      STOP
      endif
...
C--------------------------------------------------------------------------
C     Scale array "A" in case of forward FFT
...
C******************************************************************************
C******************************************************************************
C********* 1-dim. FFT required by all 2-dim. FFTs listed above ****************
...
C*******************************************************************************
      ...
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)' ERROR in the parameter list of SCRODD2048S.'
      stop
      endif
...
C     array boundaries defined by parameter "ndim".
      ...
      if(nx .gt. ndim .or. ny .gt. ndim)then
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)'   ERROR message from routine SCRODD2048S.'
      write(unit=*,fmt=*)'   Maximum allowed array dimension is 2048.'
      write(unit=*,fmt=*)
      STOP
      endif
...
C     array boundaries defined by parameter "ndim".
      ...
      if(nx .gt. ndim .or. ny .gt. ndim)then
      write(unit=*,fmt=*)
      write(unit=*,fmt=*)'   ERROR message from routine SCRODD8192S.'
      write(unit=*,fmt=*)'   Maximum allowed array dimension is 8192.'
      write(unit=*,fmt=*)
      STOP
      endif
